...
export default async function NotePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="article-shell">
      ...
      {note.imageUrl && <figure className="article-cover"><img src={note.imageUrl} alt="" /></figure>}
      <div className="article-rule"><span /></div>
      <article className="article-body"><ReactMarkdown remarkPlugins={[remarkGfm]}>{note.content}</ReactMarkdown></article>
